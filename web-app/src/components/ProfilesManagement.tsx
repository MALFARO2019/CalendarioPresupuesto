...
export function ProfilesManagement({ users, onUserUpdate }: ProfilesManagementProps) {
        ...
        try {
            await createProfile({
                ...
                permisos: {
                    ...
                    aprobarAjustes: formData.aprobarAjustes,
    ...
    const openEditModal = (profile: Profile) => {
        ...
        setFormData({
            ...
            aprobarAjustes: profile.aprobarAjustes || false,
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    {[
                                        ...
                                        { key: 'ajustarCurva', label: 'Crear/Editar Ajustes' },
                                        { key: 'aprobarAjustes', label: 'Aprobar Ajustes' },
