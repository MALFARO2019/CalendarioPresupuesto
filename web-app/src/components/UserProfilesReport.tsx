...
import { Shield, Filter, Copy, CheckCircle, Users, ChevronDown, ChevronUp } from 'lucide-react';
    ...
    return (
        <div>
            ...
            <div className="flex items-center justify-between mb-5 flex-wrap gap-3">
                <div
                    className="flex items-center gap-2 cursor-pointer hover:bg-gray-50 p-1.5 -ml-1.5 rounded-lg transition-colors select-none"
                ...
                >
                    ...
                    {isExpanded ? (
                        <ChevronUp className="w-5 h-5 text-gray-500 ml-1" />
                    ) : (
                        <ChevronDown className="w-5 h-5 text-gray-500 ml-1" />
                    )}
                </div>
                <button
                    onClick={handleCopy}
